...
MinMax
    action树全展开，检索每一种可能的状态空间来做决策。
    每一次落子，模拟了当前状态之后的所有对局情况。

    There are fewer than 300,000 possible tic-tac-toe games, peanuts for a
    modern computer.

劣势: 算法效率低，检索所有状态空间。五子棋上不可用
'''
...
def best_result(game_state):
    ...
    for candidate_move in game_state.legal_moves():
        ...
        if our_result.value > best_so_far.value:        # 所有legal move中，找收益最大的
