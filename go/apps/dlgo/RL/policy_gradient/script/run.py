...
def main_loop():
    ...
    class args:
        ...
        num_sim_games = 200 # 每轮模拟数据新增数据量
        num_sim_tasks = 10 # 模拟10轮
        num_eval_games = 50 # 评估模型对局数，可以动态调整
        ...
        model = resnet18(encoder_planes=7, num_classes=board_size*board_size)
        ...
        # agent
        temperature = 0.2 # 增加agent move的随机性
