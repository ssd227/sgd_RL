...
class GoDataProcessor:
    def __init__(self, encoder='simple', data_directory='data', process_num=multiprocessing.cpu_count()):
    ...
    def load_go_data(self, data_type='train', num_samples=1000,
        ...
        self.map_to_workers(data_type, data, cores=self.process_num)  # 进程池处理独立的zip文件， Map workload to CPUs
        
        # if use_generator:
        #     generator = DataGenerator(self.data_dir, data)
        #     return generator  # 返回一个迭代器 generator
        # else:
        #     features_and_labels = self.consolidate_games(data_type, data)
        #     return features_and_labels # 汇聚成一个train文件
    ...
    def map_to_workers(self, data_type, samples, cores):
        zip_names = set()
        indices_by_zip_name = {}
