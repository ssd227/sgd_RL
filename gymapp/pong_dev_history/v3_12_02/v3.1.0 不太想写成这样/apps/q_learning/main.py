...
from utils import show_rewards
from model.linear import PolicyNetwork
...
def train_policy_gradient(env, agent, episodes):
    ...
    for episode in range(episodes):
        ...
        if (episode + 1) % 50 == 0:
            ...
            # 保存模型参数
            agent.presist('pong_pg_policy_v3.pth')
...
def main():
    ...
    # 训练策略网络
    rewards = train_policy_gradient(env, agent, episodes=episodes)
